...
//! the `target/wasm32-wasi/release` directory. To run `wasinn-app` project, copy the wasm
//! file to the root directory of `wasinn-app` project.
//!
//! Notice that the `wasm32-wasi` target must be installed in the Rust environment. To install it,
...
fn infer_image() {
    ...
    println!("*** [Step 4] perform inference ...");
    ...
    println!("*** [Step 5] parse the inference result ...");
    // Retrieve the output.
